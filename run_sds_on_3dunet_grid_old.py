...
def main(**kwargs) -> None:
    ...
    sds_vol_mod.thre3d_repr._in_densities = pretrained_vol_mod.thre3d_repr._densities.detach()
    sds_vol_mod.thre3d_repr._in_features = pretrained_vol_mod.thre3d_repr._features.detach()
